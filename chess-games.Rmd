...
Furthermore, black's and white's id's have a very strong correlation, which confirms that many players tend to play more than one game against one another.

Finally, we can see a non negligible correlation between the chosen opening and the number of moves played in the opening phase.
